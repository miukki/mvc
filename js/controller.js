(function (window) {
	...
	function Controller(model, view) {
		...
		that.view.bind('itemDone', function (item) {
			that.setDone(item.id, item.active);
		});
	 ...
	 */
	 ...
	 Controller.prototype.setDone = function (id, active) {
		var that = this;

		that.model.update(id, {active: active}, function () {
			that.view.render('setDone', {id: id, active: active});
      that._filter(true);
		});
