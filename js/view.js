...
(function (window) {
    ...
    View.prototype._setDone = function (id, active) {
        var listItem = qs('[data-id="' + id + '"]');
        ...
        var checkbox = qs('input.toggle', listItem);
        console.log('checkbox.checked', checkbox.checked, active)
    ...
    View.prototype.render = function (viewCmd, parameter) {
        ...
        var viewCommands = {
            ...
            setDone: function () {
                that._setDone(parameter.id, parameter.active);
            }
        };
   ...
   View.prototype._itemChecked = function (element) {
    ...
    View.prototype.bind = function (event, handler) {
        ...
        } else if (event === 'itemDone') {
            $live('#todo-list .toggle', 'click', function () {
                handler({id: that._itemId(this), active: that._itemChecked(this)});
            });
